...
func (_c *UserCreate) SetRole(v primitive.UserRole) *UserCreate {
	_c.mutation.SetRole(v)
	return _c
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_c *UserCreate) SetNillableRole(v *primitive.UserRole) *UserCreate {
	if v != nil {
		_c.SetRole(*v)
	}
	return _c
...
// SetRole sets the "role" field.
func (u *UserUpsert) SetRole(v primitive.UserRole) *UserUpsert {
...
// SetRole sets the "role" field.
func (u *UserUpsertOne) SetRole(v primitive.UserRole) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetRole(v)
	})
}
...
// SetRole sets the "role" field.
func (u *UserUpsertBulk) SetRole(v primitive.UserRole) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetRole(v)
	})
}
